...
public class MyPushMessageReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        try {
            ...
            } else if (ex.equals("SLEEP") || ex.equals("GETUP") || ex.equals("EAT") || ex.equals("GAME") || ex.equals("SHOP")) {
                Intent reminder;
                int extra = 0;
                if (ex.equals("SLEEP")) {
            ...
            } else if (ex.equals("MENSES_COME") || ex.equals("MENSES_GONE") || ex.equals("DISEASE_COME") || ex.equals("DISEASE_GONE") || ex.equals("DRUG")) {
                int extra = 0;
